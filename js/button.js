...
function CreateCoffeeAutomateInterface(container) {
		...
		*/
		let containerId = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15)
       	...
       	let coffeeAutomate = new CoffeeAutomate(3, 3, 50)	
...
let button1 = new CreateCoffeeAutomateInterface("container1")
let button2 = new CreateCoffeeAutomateInterface("container2")
let button3 = new CreateCoffeeAutomateInterface("container3")
